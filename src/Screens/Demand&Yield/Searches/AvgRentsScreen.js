  ...
  const fetchPriceSearch = async () => {
    try {
      const response = await fetch(
        `https://api.propertydata.co.uk/rents?key=TORGPUR3KY&postcode=${postcode}&bedrooms=${bedroomNum}`
      );
          ...
          <View style={styles.graphContainer}>
            ...
            >
              <VictoryGroup offset={15} colorScale={"qualitative"}>
                <VictoryBar
                  data={[
                    { x: 1, y: data.data["long_let"]["70pc_range"][0] },
                    { x: 2, y: data.data["long_let"]["80pc_range"][0] },
                    { x: 3, y: data.data["long_let"]["90pc_range"][0] },
                    { x: 4, y: data.data["long_let"]["100pc_range"][0] },
                  ]}
                  animate={{
                    duration: 1000,
                ...
                <VictoryBar
                  data={[
                    { x: 1, y: data.data["long_let"]["70pc_range"][1] },
                    { x: 2, y: data.data["long_let"]["80pc_range"][1] },
                    { x: 3, y: data.data["long_let"]["90pc_range"][1] },
                    { x: 4, y: data.data["long_let"]["100pc_range"][1] },
                  ]}
                  animate={{
                    duration: 2000,
                    onLoad: { duration: 1000 },
